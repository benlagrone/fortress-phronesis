...
- Cutover steps: `docker compose -p fortress-phronesis -f docker-compose.pericope.yml up -d`; update Nginx upstreams to 127.0.0.1:18000/13080; reload Nginx; smoke-test `/` and `/api`.
