...
| SVC-001 | Serviceized persona deploy model (`service_id` / `service_version`) | v1.3.1 | In Progress | [roadmap.md](roadmap.md#v131--serviceized-persona-deployment-x-as-a-service) |
